...
// Same shape as EducatorLoginForm, and for the same reason it has no signup
// link: counsellor accounts are provisioned, never self-created. The role
// routing already happens in /api/auth/login via homePathForRole.
export default function NimcLoginForm() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(data.redirect ?? "/nimc");
      router.refresh();
    } catch {
