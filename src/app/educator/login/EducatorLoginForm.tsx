...
// Same shape as PracticeLoginForm, minus the signup link — educator accounts
// are provisioned, not self-created. /api/auth/login already routes by role
// via homePathForRole, so nothing here needs to know about /educator.
export default function EducatorLoginForm() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(data.redirect ?? "/educator");
      router.refresh();
    } catch {
